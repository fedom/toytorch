...
class MyNet1 : public Module {
 public:
  MyNet1()
      : fc1_(register_module("fc1", std::make_shared<Linear>(4, 32, "", "fc1"))),
        fc2_(register_module("fc2", std::make_shared<Linear>(32, 1, "", "fc2"))) {}
...
class MyNet2 : public Module {
 public:
  MyNet2() : net1_(register_module("net1", std::make_shared<MyNet1>())), 
             fc_(register_module("fc", std::make_shared<Linear>(16, 4, "", "fc"))) {}
