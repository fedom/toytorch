...
class Conv1dBackwardTest : public testing::Test {
 ...
 protected:
  ...
  Conv1dBackwardTest() : conv_(in_channels, out_channels, kernel_size) {
    ...
    input_ = ones({batch_size, in_channels, input_size}, true);
  }
...
// See unit/nn/modules/conv2d.cpp
TEST_F(Conv1dBackwardTest, Backward) {

  // std::cout << debug::print_backward_graph(result) << std::endl;
  run_forward_backward();

  EXPECT_TRUE(conv_.weights().grad()->strict_allclose(
      Tensor({out_channels, in_channels, kernel_size}, 40), 1e-6, 1e-4));

  EXPECT_TRUE(conv_.bias().grad()->strict_allclose(
      Tensor({out_channels, 1}, 40), 1e-6, 1e-4));

  EXPECT_TRUE(input_.grad()->strict_allclose(
      Tensor(input_.shape(),
             {0.0051,  -0.1812, 0.2856,  0.2625,  0.2367,  -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0707,
              0.1156,  -0.3512, -0.3281, -0.3023, 0.3288,  0.2983,  0.5140,
              0.5316,  0.6971,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.2302,  0.2607,  0.0450,  0.0274,
              -0.1381, 0.1249,  0.1286,  0.4488,  0.5051,  0.6401,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.4342,  0.4305,  0.1103,  0.0540,  -0.0810, 0.1094,  0.0950,
              0.4882,  0.4685,  0.4323,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.2855,  0.2999,  -0.0933,
              -0.0736, -0.0374, -0.1688, 0.0694,  0.1632,  -0.0054, 0.2074,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.4172,  0.1790,  0.0852,  0.2538,  0.0410,  0.0087,
              0.1637,  -0.1951, -0.0336, -0.1313, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0193, -0.1743,
              0.1845,  0.0230,  0.1207,  0.0998,  0.2311,  0.3576,  0.5191,
              0.0611,  -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.3306, -0.4619, -0.5884, -0.7499, -0.2919,
              -0.2800, -0.4527, -0.2751, -0.1473, 0.0420,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.2823,
              0.4550,  0.2774,  0.1496,  -0.0397, 0.0051,  -0.1812, 0.2856,
              0.2625,  0.2367,  -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0707, 0.1156,  -0.3512, -0.3281,
              -0.3023, 0.3288,  0.2983,  0.5140,  0.5316,  0.6971,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.2302,  0.2607,  0.0450,  0.0274,  -0.1381, 0.1249,  0.1286,
              0.4488,  0.5051,  0.6401,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.4342,  0.4305,  0.1103,
              0.0540,  -0.0810, 0.1094,  0.0950,  0.4882,  0.4685,  0.4323,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.2855,  0.2999,  -0.0933, -0.0736, -0.0374, -0.1688,
              0.0694,  0.1632,  -0.0054, 0.2074,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.4172,  0.1790,
              0.0852,  0.2538,  0.0410,  0.0087,  0.1637,  -0.1951, -0.0336,
              -0.1313, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0193, -0.1743, 0.1845,  0.0230,  0.1207,
              0.0998,  0.2311,  0.3576,  0.5191,  0.0611,  -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.3306,
              -0.4619, -0.5884, -0.7499, -0.2919, -0.2800, -0.4527, -0.2751,
              -0.1473, 0.0420,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.2823,  0.4550,  0.2774,  0.1496,
              -0.0397}),
      1e-6, 1e-3));
}

TEST_F(Conv1dBackwardTest, BackwardWithPadding_2) {
  ...
  EXPECT_TRUE(conv_.weights().grad()->strict_allclose(
      Tensor(
          {out_channels, in_channels, kernel_size},
          {44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46.,
           48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46., 48., 48.,
           46., 44., 44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44.,
           44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46.,
           48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46., 48., 48.,
           46., 44., 44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44.,
           44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46.,
           ...
           44., 46., 48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46.,
           48., 48., 46., 44., 44., 46., 48., 48., 46., 44., 44., 46., 48., 48.,
           46., 44., 44., 46., 48., 48., 46., 44.}),
      1e-6, 1e-4));

  EXPECT_TRUE(conv_.bias().grad()->strict_allclose(
      Tensor({out_channels, 1}, 48), 1e-6, 1e-4));

  // input_.grad()->print();
  EXPECT_TRUE(input_.grad()->strict_allclose(
      Tensor(input_.shape(),
             {0.2856,  0.2625,  0.2367,  -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0707, 0.1156,  -0.3512, 0.5140,  0.5316,  0.6971,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.2302,  0.2607,
              0.0450,  0.4488,  0.5051,  0.6401,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.4342,  0.4305,  0.1103,  0.4882,  0.4685,
              0.4323,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.2855,
              0.2999,  -0.0933, 0.1632,  -0.0054, 0.2074,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.4172,  0.1790,  0.0852,  -0.1951,
              -0.0336, -0.1313, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0193, -0.1743, 0.1845,  0.3576,  0.5191,  0.0611,  -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.3306, -0.4619, -0.5884,
              -0.2751, -0.1473, 0.0420,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.2823,  0.4550,  0.2774,  0.2856,  0.2625,  0.2367,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0656,
              -0.0656, -0.0656, -0.0656, -0.0656, -0.0656, -0.0707, 0.1156,
              -0.3512, 0.5140,  0.5316,  0.6971,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,  0.5590,
              0.5590,  0.5590,  0.2302,  0.2607,  0.0450,  0.4488,  0.5051,
              0.6401,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,
              0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.5591,  0.4342,
              0.4305,  0.1103,  0.4882,  0.4685,  0.4323,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,  0.3949,
              0.3949,  0.3949,  0.3949,  0.2855,  0.2999,  -0.0933, 0.1632,
              -0.0054, 0.2074,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,  0.2484,
              0.4172,  0.1790,  0.0852,  -0.1951, -0.0336, -0.1313, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106, -0.0106,
              -0.0106, -0.0106, -0.0106, -0.0106, -0.0193, -0.1743, 0.1845,
              0.3576,  0.5191,  0.0611,  -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308, -0.2308,
              -0.2308, -0.3306, -0.4619, -0.5884, -0.2751, -0.1473, 0.0420,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.0023,
              0.0023,  0.0023,  0.0023,  0.0023,  0.0023,  0.2823,  0.4550,
              0.2774}),
      1e-6, 1e-3));
}

TEST_F(Conv1dBackwardTest, BackwardFilerWithStrides_2) {

  conv_.debug_set_stride(2);
  run_forward_backward();
  ...
  // conv_.weights().grad()->print();
  EXPECT_TRUE(conv_.weights().grad()->strict_allclose(
      Tensor({out_channels, in_channels, kernel_size}, 20), 1e-6, 1e-4));

  EXPECT_TRUE(conv_.bias().grad()->strict_allclose(
      Tensor({out_channels, 1}, 20), 1e-6, 1e-4));

  // input_.grad()->print_shape();
  // input_.grad()->print();
  EXPECT_TRUE(input_.grad()->strict_allclose(
      Tensor(input_.shape(),
             {0.0051,  -0.1863, 0.4719,  -0.2094, 0.4461,  -0.5117, 0.4461,
              -0.5117, 0.4461,  -0.5117, 0.4461,  -0.5117, 0.4461,  -0.5117,
              0.4461,  -0.5117, 0.4461,  -0.5117, 0.4461,  -0.5117, 0.4410,
              -0.3254, -0.0258, -0.3023, 0.0000,  0.3288,  -0.0305, 0.5445,
              -0.0129, 0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,  -0.1510,
              0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,
              -0.1510, 0.7100,  -0.1510, 0.3812,  -0.1205, 0.1655,  -0.1381,
              0.0000,  0.1249,  0.0037,  0.4451,  0.0600,  0.5801,  -0.0210,
              0.5801,  -0.0210, 0.5801,  -0.0210, 0.5801,  -0.0210, 0.5801,
              -0.0210, 0.5801,  -0.0210, 0.5801,  -0.0210, 0.5801,  -0.0210,
              0.4552,  -0.0247, 0.1350,  -0.0810, 0.0000,  0.1094,  -0.0144,
              0.5026,  -0.0341, 0.4664,  -0.0715, 0.4664,  -0.0715, 0.4664,
              -0.0715, 0.4664,  -0.0715, 0.4664,  -0.0715, 0.4664,  -0.0715,
              0.4664,  -0.0715, 0.4664,  -0.0715, 0.3570,  -0.0571, -0.0362,
              -0.0374, 0.0000,  -0.1688, 0.2382,  -0.0750, 0.0696,  0.1378,
              0.1106,  0.1378,  0.1106,  0.1378,  0.1106,  0.1378,  0.1106,
              0.1378,  0.1106,  0.1378,  0.1106,  0.1378,  0.1106,  0.1378,
              0.1106,  0.3066,  -0.1276, 0.2128,  0.0410,  0.0000,  0.0087,
              0.1550,  -0.3501, 0.3165,  -0.4478, 0.4372,  -0.4478, 0.4372,
              -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4478,
              0.4372,  -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4565, 0.2822,
              -0.0977, 0.1207,  0.0000,  0.0998,  0.1313,  0.2263,  0.2928,
              -0.2317, 0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,  -0.2317,
              0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,
              -0.2317, 0.0009,  -0.3315, -0.1304, -0.4580, -0.2919, 0.0000,
              -0.2800, -0.1727, -0.1024, -0.0449, 0.0869,  -0.0846, 0.0869,
              -0.0846, 0.0869,  -0.0846, 0.0869,  -0.0846, 0.0869,  -0.0846,
              0.0869,  -0.0846, 0.0869,  -0.0846, 0.0869,  -0.0846, 0.3669,
              0.0881,  0.1893,  -0.0397, 0.0000,  0.0051,  -0.1863, 0.4719,
              -0.2094, 0.4461,  -0.5117, 0.4461,  -0.5117, 0.4461,  -0.5117,
              0.4461,  -0.5117, 0.4461,  -0.5117, 0.4461,  -0.5117, 0.4461,
              -0.5117, 0.4461,  -0.5117, 0.4410,  -0.3254, -0.0258, -0.3023,
              0.0000,  0.3288,  -0.0305, 0.5445,  -0.0129, 0.7100,  -0.1510,
              0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,
              -0.1510, 0.7100,  -0.1510, 0.7100,  -0.1510, 0.7100,  -0.1510,
              0.3812,  -0.1205, 0.1655,  -0.1381, 0.0000,  0.1249,  0.0037,
              0.4451,  0.0600,  0.5801,  -0.0210, 0.5801,  -0.0210, 0.5801,
              -0.0210, 0.5801,  -0.0210, 0.5801,  -0.0210, 0.5801,  -0.0210,
              0.5801,  -0.0210, 0.5801,  -0.0210, 0.4552,  -0.0247, 0.1350,
              -0.0810, 0.0000,  0.1094,  -0.0144, 0.5026,  -0.0341, 0.4664,
              -0.0715, 0.4664,  -0.0715, 0.4664,  -0.0715, 0.4664,  -0.0715,
              0.4664,  -0.0715, 0.4664,  -0.0715, 0.4664,  -0.0715, 0.4664,
              -0.0715, 0.3570,  -0.0571, -0.0362, -0.0374, 0.0000,  -0.1688,
              0.2382,  -0.0750, 0.0696,  0.1378,  0.1106,  0.1378,  0.1106,
              0.1378,  0.1106,  0.1378,  0.1106,  0.1378,  0.1106,  0.1378,
              0.1106,  0.1378,  0.1106,  0.1378,  0.1106,  0.3066,  -0.1276,
              0.2128,  0.0410,  0.0000,  0.0087,  0.1550,  -0.3501, 0.3165,
              -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4478,
              0.4372,  -0.4478, 0.4372,  -0.4478, 0.4372,  -0.4478, 0.4372,
              -0.4478, 0.4372,  -0.4565, 0.2822,  -0.0977, 0.1207,  0.0000,
              0.0998,  0.1313,  0.2263,  0.2928,  -0.2317, 0.0009,  -0.2317,
              0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,
              -0.2317, 0.0009,  -0.2317, 0.0009,  -0.2317, 0.0009,  -0.3315,
              -0.1304, -0.4580, -0.2919, 0.0000,  -0.2800, -0.1727, -0.1024,
              -0.0449, 0.0869,  -0.0846, 0.0869,  -0.0846, 0.0869,  -0.0846,
              0.0869,  -0.0846, 0.0869,  -0.0846, 0.0869,  -0.0846, 0.0869,
              -0.0846, 0.0869,  -0.0846, 0.3669,  0.0881,  0.1893,  -0.0397,
              0.0000}),
      1e-6, 1e-3));
}

TEST_F(Conv1dBackwardTest, BackwardFilerWithStrides_3) {

  conv_.debug_set_stride(3);
  run_forward_backward();

  EXPECT_TRUE(conv_.weights().grad()->strict_allclose(
      Tensor({out_channels, in_channels, kernel_size}, 14), 1e-6, 1e-4));

  EXPECT_TRUE(conv_.bias().grad()->strict_allclose(
      Tensor({out_channels, 1}, 14), 1e-6, 1e-4));

  // input_.grad()->print();
  EXPECT_TRUE(input_.grad()->strict_allclose(
      Tensor(input_.shape(),
             {0.0051,  -0.1863, 0.4668,  -0.0180, -0.2121, 0.1645,  -0.0180,
              -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121,
              0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,
              -0.0231, -0.0258, -0.3023, 0.0000,  0.3288,  -0.0305, 0.2157,
              0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,
              0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,  0.1350,
              0.0776,  0.3464,  0.1350,  0.0776,  0.0176,  0.1655,  -0.1381,
              0.0000,  0.1249,  0.0037,  0.3202,  0.1812,  0.1387,  0.2392,
              0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.1812,
              0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,
              0.2392,  0.0563,  0.1350,  -0.0810, 0.0000,  0.1094,  -0.0144,
              0.3932,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,
              0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,
              -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  -0.0197, -0.0362,
              -0.0374, 0.0000,  -0.1688, 0.2382,  0.0938,  -0.3374, 0.4510,
              0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,
              -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374,
              0.4510,  0.1348,  -0.1686, 0.2128,  0.0410,  0.0000,  0.0087,
              0.1550,  -0.3588, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,
              -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381,
              0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1615,
              -0.0977, 0.1207,  0.0000,  0.0998,  0.1313,  0.1265,  0.2613,
              -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267,
              -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654,
              0.2613,  -0.3267, -0.1654, 0.1615,  -0.4580, -0.2919, 0.0000,
              -0.2800, -0.1727, 0.1776,  -0.1522, 0.0166,  0.1379,  -0.1522,
              0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,
              0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,
              0.1278,  0.1893,  -0.0397, 0.0000,  0.0051,  -0.1863, 0.4668,
              -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180,
              -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121,
              0.1645,  -0.0180, -0.2121, 0.1645,  -0.0231, -0.0258, -0.3023,
              0.0000,  0.3288,  -0.0305, 0.2157,  0.3464,  0.1350,  0.0776,
              0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,
              0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,  0.1350,
              0.0776,  0.0176,  0.1655,  -0.1381, 0.0000,  0.1249,  0.0037,
              0.3202,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,
              0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.1812,
              0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.0563,  0.1350,
              -0.0810, 0.0000,  0.1094,  -0.0144, 0.3932,  0.0897,  -0.0506,
              0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,
              0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,
              -0.0506, 0.3558,  -0.0197, -0.0362, -0.0374, 0.0000,  -0.1688,
              0.2382,  0.0938,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,
              0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,
              -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,  -0.1686,
              0.2128,  0.0410,  0.0000,  0.0087,  0.1550,  -0.3588, 0.1702,
              0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,
              -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381,
              0.1702,  0.0573,  -0.2381, 0.1615,  -0.0977, 0.1207,  0.0000,
              0.0998,  0.1313,  0.1265,  0.2613,  -0.3267, -0.1654, 0.2613,
              -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267,
              -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654,
              0.1615,  -0.4580, -0.2919, 0.0000,  -0.2800, -0.1727, 0.1776,
              -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522,
              0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,
              0.1379,  -0.1522, 0.0166,  0.1379,  0.1278,  0.1893,  -0.0397,
              0.0000}),
      1e-6, 1e-3));
}

TEST_F(Conv1dBackwardTest, BackwardWithPadding_2_Strides_3) {
  ...
  EXPECT_TRUE(conv_.weights().grad()->strict_allclose(
      Tensor(
          {out_channels, in_channels, kernel_size},
          {14., 14., 16., 16., 16., 16., 14., 14., 16., 16., 16., 16., 14., 14.,
           16., 16., 16., 16., 14., 14., 16., 16., 16., 16., 14., 14., 16., 16.,
           16., 16., 14., 14., 16., 16., 16., 16., 14., 14., 16., 16., 16., 16.,
           14., 14., 16., 16., 16., 16., 14., 14., 16., 16., 16., 16., 14., 14.,
           16., 16., 16., 16., 14., 14., 16., 16., 16., 16., 14., 14., 16., 16.,
           16., 16., 14., 14., 16., 16., 16., 16., 14., 14., 16., 16., 16., 16.,
           14., 14., 16., 16., 16., 16., 14., 14., 16., 16., 16., 16., 14., 14.,
  ...
  EXPECT_TRUE(conv_.bias().grad()->strict_allclose(
      Tensor({out_channels, 1}, 16), 1e-6, 1e-4));

  // input_.grad()->print();
  EXPECT_TRUE(input_.grad()->strict_allclose(
      Tensor(input_.shape(),
             {0.4668,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,
              -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180,
              -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121,
              0.1645,  -0.0231, -0.0258, -0.3023, 0.2157,  0.3464,  0.1350,
              0.0776,  0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,
              0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,
              0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.0176,  0.1655,
              -0.1381, 0.3202,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,
              0.2392,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,
              0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.1812,
              0.1387,  0.2392,  0.0563,  0.1350,  -0.0810, 0.3932,  0.0897,
              -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506,
              0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,
              0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  -0.0197,
              -0.0362, -0.0374, 0.0938,  -0.3374, 0.4510,  0.1348,  -0.3374,
              0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,
              0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,
              -0.3374, 0.4510,  0.1348,  -0.1686, 0.2128,  0.0410,  -0.3588,
              0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,
              0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,
              -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381,
              0.1615,  -0.0977, 0.1207,  0.1265,  0.2613,  -0.3267, -0.1654,
              0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,
              -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267,
              -0.1654, 0.2613,  -0.3267, -0.1654, 0.1615,  -0.4580, -0.2919,
              0.1776,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,
              -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522,
              0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,
              0.1379,  0.1278,  0.1893,  -0.0397, 0.4668,  -0.0180, -0.2121,
              0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,
              -0.0180, -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0180,
              -0.2121, 0.1645,  -0.0180, -0.2121, 0.1645,  -0.0231, -0.0258,
              -0.3023, 0.2157,  0.3464,  0.1350,  0.0776,  0.3464,  0.1350,
              0.0776,  0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,
              0.3464,  0.1350,  0.0776,  0.3464,  0.1350,  0.0776,  0.3464,
              0.1350,  0.0776,  0.0176,  0.1655,  -0.1381, 0.3202,  0.1812,
              0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,
              0.2392,  0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,
              0.1812,  0.1387,  0.2392,  0.1812,  0.1387,  0.2392,  0.0563,
              0.1350,  -0.0810, 0.3932,  0.0897,  -0.0506, 0.3558,  0.0897,
              -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506,
              0.3558,  0.0897,  -0.0506, 0.3558,  0.0897,  -0.0506, 0.3558,
              0.0897,  -0.0506, 0.3558,  -0.0197, -0.0362, -0.0374, 0.0938,
              -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374,
              0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,
              0.1348,  -0.3374, 0.4510,  0.1348,  -0.3374, 0.4510,  0.1348,
              -0.1686, 0.2128,  0.0410,  -0.3588, 0.1702,  0.0573,  -0.2381,
              0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,
              0.0573,  -0.2381, 0.1702,  0.0573,  -0.2381, 0.1702,  0.0573,
              -0.2381, 0.1702,  0.0573,  -0.2381, 0.1615,  -0.0977, 0.1207,
              0.1265,  0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654,
              0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,
              -0.3267, -0.1654, 0.2613,  -0.3267, -0.1654, 0.2613,  -0.3267,
              -0.1654, 0.1615,  -0.4580, -0.2919, 0.1776,  -0.1522, 0.0166,
              0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,
              -0.1522, 0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  -0.1522,
              0.0166,  0.1379,  -0.1522, 0.0166,  0.1379,  0.1278,  0.1893,
              -0.0397}),
      1e-6, 1e-3));
}
